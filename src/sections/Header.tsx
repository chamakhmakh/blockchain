            ...
            <div className="flex gap-4 items-center">
              ...
              >
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                  <div
                    className={twMerge(
                      "w-5 h-0.5 bg-zinc-300 -transalte-y-1 transition-all duration-500",
              ...
              <div className="h-full flex justify-center items-center">
                <nav className="flex flex-col items-center gap-12 md:gap-16">
                  {navLinks.map(({ title, href }, index) => (
                    ...
                    >
                      <span
                        className="text-4xl md:text-5xl lg:text-3xl font-heading font-black text-zinc-500 hover:text-zinc-300 
