...
const listItems = [
  ...
  "Unlock the potantial of decentralized networks",
];
...
export const FeaturesGrid = () => {
  ...
  const torusKnotTrasnslateY = useTransform(
  ...
  const firstHemisphereTrasnslateY = useTransform(
  ...
  const coneTrasnslateY = useTransform(
    coneScrollYProgress,
    [0, 1],
    [100, -100]
  );
  ...
  const secondHemisphereTrasnslateY = useTransform(
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="col-span-2">
              ...
              <p className="text-xl lg:text-2xl text-zinc-400 mt-8">
                Blockforge provides ronust and secure infrastructure to support
                the next generation of decentralized applications.
              </p>
              <ul className="flex flex-col gap-8 mt-12">
                {listItems.map((item) => (
                  <li key={item} className="flex itmes-center gap-3">
                    <div
                      className="inline-flex flex-shrink-0 justify-center items-center size-8 outline 
                        outline-4 -outline-offset-4 outline-fuchsia-500/10 rounded-full"
                    >
            ...
            <div className="hidden md:block">
              <div className="relative inline-flex z-0">
                <motion.img
                  ...
                  ref={torusKnotRef}
                  style={{
                    translateY: torusKnotTrasnslateY,
                ...
                <motion.img
                  ...
                  style={{
                    translateY: firstHemisphereTrasnslateY,
            ...
            <div className="relative hidden md:block">
              <div className="absolute right-0 z-0">
                ...
                <motion.img
                  ...
                  style={{
                    translateY: secondHemisphereTrasnslateY,
            ...
            <div className="col-span-2">
              ...
              <div className="flex flex-col text-xl lg:text-2xl text-zinc-400 mt-6 gap-6">
                ...
                <p>
                  ...
                  blockchain scaling platform, Blockforg enables developers to
                  create scalable, user-friendly Apps with low transaction
                  costs, all ensuring robust security.
                </p>
              </div>
              <div className="flex gap-8 mt-12">
                <CutCornerButton>Get Started</CutCornerButton>
